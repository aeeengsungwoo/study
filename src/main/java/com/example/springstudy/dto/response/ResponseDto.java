...
import com.example.springstudy.dto.exception.ExceptionDto;
import com.example.springstudy.dto.exception.InvalidateArgumentExceptionDto;
import com.example.springstudy.dto.exception.JSONConvertExceptionDto;
        ...
        return ResponseEntity.status(e.getError().getHttpStatus())
                .body(
                        ResponseDto.builder()
                                .isSuccess(false)
                                .responseDto(null)
                                .responseDto(new ExceptionDto(e.getError()))
                                .build());
    }
